...
// XP is no longer edited here. It belongs to a CHARACTER, not to the person on this row, and
// lives in SessionXpPanel.vue — see tests/unit/components/SessionXpPanel.test.ts.
