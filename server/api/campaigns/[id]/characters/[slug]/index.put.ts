...
export default defineEventHandler((event) =>
  withApiHandler(event, async () => {
    ...
    if (body.locationEntityId !== undefined)
      charUpdates.locationEntityId = body.locationEntityId || null
    if (body.folderId !== undefined) charUpdates.folderId = body.folderId || null
    ...
    if (body.ownerUserId !== undefined) charUpdates.ownerUserId = body.ownerUserId || null
