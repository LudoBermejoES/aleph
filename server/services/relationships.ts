...
export const BUILTIN_RELATION_TYPES = [
  ...
  { slug: 'parent_of', forward: 'parent of', reverse: 'child of' },
  { slug: 'spouse_of', forward: 'spouse of', reverse: 'spouse of' },
  { slug: 'sibling_of', forward: 'sibling of', reverse: 'sibling of' },
