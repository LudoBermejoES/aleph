<template>
  <div :class="['relative', sizeClass]">
    ...
    <div
      v-else
      :class="[
        'rounded-lg bg-secondary flex items-center justify-center w-full h-full',
        editable ? 'cursor-pointer hover:bg-secondary/70 transition-colors' : '',
      ]"
    ...
    <div
      v-if="uploading"
      class="absolute inset-0 rounded-lg bg-black/50 flex items-center justify-center"
    >
