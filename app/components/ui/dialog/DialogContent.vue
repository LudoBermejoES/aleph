...
<template>
  <DialogPortal>
    ...
    />
    <!-- `bg-background` MUST stay paired with `text-foreground`. DialogPortal teleports
         this subtree to <body>, i.e. outside the layout root div that supplies the app's
