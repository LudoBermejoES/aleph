<template>
  <div class="p-8 max-w-5xl">
    ...
    <div v-else class="space-y-2">
      <div v-for="loc in locations" :key="loc.id" class="flex items-center gap-3 p-3 rounded-lg border border-border hover:bg-accent/30 transition-colors">
...
watch([search, subtypeFilter], () => {
  ...
  searchTimer = setTimeout(() => { pagination.setPage(1); load() }, 300)
})
