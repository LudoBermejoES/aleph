...
/opsx:propose fix-session-attendance-bug
```
...
AI:  Archiving add-quest-objectives...
...
AI:  ✓ Synced specs to openspec/specs/quests/spec.md
     ✓ Moved to openspec/changes/archive/2026-03-26-add-quest-objectives/
```
...
AI:  Change: add-quest-objectives
     ...
     Creating specs...
     ✓ Created openspec/changes/add-quest-objectives/specs/quests/spec.md
