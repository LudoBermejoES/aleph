---
layout: page
permalink: /campana/personajes/dain-golka/
title: Dain Golka
chapter: Campaña
category: campana
source: Kingmaker
...
| ------------------- | ----------------------------------------- |
| **Nombre**          | Dain Golka                                |
| **Clase**           | [Guerrero (Atletismo)](/clases/guerrero/) |
| **Nivel**           | 1                                         |
| **Ascendencia**     | [Enano](/ascendencias/enano/)             |
| **Linaje**          | Enano de la roca                          |
| **Bagaje**          | Combatiente                               |
| **Tamaño**          | Mediano                                   |
| **Velocidad**       | 6 metros (20 pies)                        |
| **Atributo clave**  | Fuerza                                    |
| **Puntos de Golpe** | 23 (10 ascendencia + 10 clase + +3 Con)   |
...
| Armadura pesada | Entrenado |
| Armas simples   | Experto   |
| Armas marciales | Experto   |
| Armas avanzadas | Entrenado |
| Desarmado       | Experto   |
...
| Dote                                                                 | Tipo                | Nivel |
| -------------------------------------------------------------------- | ------------------- | :---: |
| Bloqueo con el escudo                                                | Aptitud de clase    |   1   |
| [Bloqueo con el escudo](/dotes/generales/bloqueo-con-el-escudo/)     | Dote general        |   1   |
| Daga de clan                                                         | ancestryfeature     |   1   |
| [Escudo reactivo](/dotes/guerrero/escudo-reactivo/)                  | Dote de clase       |   1   |
| Golpe reactivo                                                       | Aptitud de clase    |   1   |
| [Mirada intimidante](/dotes/habilidad/mirada-intimidante/)           | Dote de habilidad   |   1   |
| [No impedido por el hierro](/dotes/enano/no-impedido-por-el-hierro/) | Dote de ascendencia |   1   |
...
| ----------------------------------- | ----- | :--------------: |
| [Coraza](/equipo/armaduras/coraza/) | Media |        +4        |
...
Dain Golka es un(a) **Guerrero (Atletismo)** de nivel 1.
Su bagaje es **Combatiente**.

→ [Ejemplos de juego: cómo jugar a Dain Golka](/campana/personajes/ejemplos/dain-golka/)
