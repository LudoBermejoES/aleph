# markdown-long-text Specification

## Purpose

Defines which entity fields use full markdown rendering (MDC) and the MarkdownEditor component, extending the basic markdown-content spec to cover arc, chapter, quest, location, organization, and item description fields.
