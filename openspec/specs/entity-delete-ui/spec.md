# entity-delete-ui Specification

## Purpose

Defines the delete action UI present on entity, character, map, and organization detail pages. Delete is gated to `dm` and `co_dm` roles, requires a confirmation dialog, and redirects to the corresponding list page on success.
