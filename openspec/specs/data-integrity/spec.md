...
Ensure that multi-write database operations in the API are atomic by wrapping them in transactions, preventing orphaned or partially-written rows when any step fails.
