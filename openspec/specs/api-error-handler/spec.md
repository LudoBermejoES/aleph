# api-error-handler Specification

## Purpose

Provide a reusable `withApiHandler` wrapper that centralises error handling across server API endpoints, ensuring unexpected errors produce safe 500 responses, H3 errors are preserved, and all errors are logged at the appropriate level.
