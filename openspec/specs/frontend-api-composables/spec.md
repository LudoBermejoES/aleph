# frontend-api-composables Specification

## Purpose

Split the 961-line `useCampaignApi` monolith into focused domain composables while preserving full backward compatibility for all existing consumers.
