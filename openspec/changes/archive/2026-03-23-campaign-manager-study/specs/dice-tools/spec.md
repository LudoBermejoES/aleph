# Aleph -- Dice & Utility Tools Specification

## Purpose

Define the dice rolling system, random generators, and utility tools (whiteboards, toolboards) that support live gameplay.
