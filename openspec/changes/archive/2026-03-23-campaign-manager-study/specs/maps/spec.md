# Aleph -- Interactive Maps Specification

## Purpose

Define the interactive map system that allows users to upload, annotate, and navigate visual maps with pins, layers, regions, and nested map hierarchies.
