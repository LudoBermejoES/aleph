# Aleph -- Character Management Specification

## Purpose

Define the character system for player characters (PCs), non-player characters (NPCs), and creatures -- including profiles, custom stats, abilities, relationships, and family trees.

## ADDED Requirements

### Requirement: Character Profiles

The system SHALL support rich character profiles stored as markdown files with structured frontmatter.
...
- THEN the default profile fields include:
  ...
  - Faction membership (linked to faction entities)
  - Portrait image
  - Description, backstory, personality, goals (markdown body sections)
