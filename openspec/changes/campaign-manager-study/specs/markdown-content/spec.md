# Aleph -- Markdown-First Content Engine Specification

## Purpose

Define the architecture for storing, rendering, and managing all entity content as markdown files on the filesystem. The database handles metadata, relationships, and permissions only. This is a core architectural principle that affects every other feature.
