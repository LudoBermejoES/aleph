...
- THEN the following tables are used:
  ...
  - `quests` (id, campaign_id, name, description, short_description, status, parent_quest_id, visibility, assigned_to_json, created_at, updated_at)
...
- AND `short_description` is nullable plain text of at most 200 characters, independent of `description`
