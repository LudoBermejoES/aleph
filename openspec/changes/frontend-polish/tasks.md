...
- [x] 12.1 Extract `app/components/forms/EntityForm.vue` — shared form used by both entities/new.vue and entities/[slug]/edit.vue
- [x] 12.2 Extract `app/components/forms/CharacterForm.vue` — shared form for characters
- [x] 12.3 Extract `app/components/forms/CalendarForm.vue` — shared form for calendars
- [x] 12.4 Extract `app/components/forms/TimelineForm.vue` — shared form for timelines
- [x] 12.5 Extract `app/components/forms/SessionForm.vue` — shared form for sessions
- [x] 12.6 Extract `app/components/forms/MapForm.vue` — shared form for maps
- [x] 12.7 Extract `app/components/forms/QuestForm.vue` — shared form for quests
- [x] 12.8 Extract `app/components/forms/ItemForm.vue` — shared form for items
- [x] 12.9 Extract `app/components/forms/ShopForm.vue` — shared form for shops
- [x] 12.10 Extract `app/components/forms/RelationForm.vue` — shared form for relations
...
- [x] 12.26 Update entities/new.vue — use EntityForm component
- [x] 12.27 Update characters/new.vue — use CharacterForm component
- [x] 12.28 Update calendars/new.vue — use CalendarForm component
- [x] 12.29 Update timelines/new.vue — use TimelineForm component
- [x] 12.30 Update sessions/new.vue — use SessionForm component
- [x] 12.31 Update maps/new.vue — use MapForm component
- [x] 12.32 Update quests/new.vue — use QuestForm component
- [x] 12.33 Update items/new.vue — use ItemForm component
- [x] 12.34 Update shops/new.vue — use ShopForm component
- [x] 12.35 Update relations/new.vue — use RelationForm component
